        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <div className="mb-8">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-purple-500 rounded-xl flex items-center justify-center">
                  {navigationData[activeSection].icon}
                </div>
                <div>
                  <h2 className="text-3xl font-bold text-white">{navigationData[activeSection].title}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {navigationData[activeSection].items.map((item, index) => (
                <motion.a
                  key={item.name}
                  href={item.url}
                  target="_blank"
...
export default FrontendNavigationNew;
